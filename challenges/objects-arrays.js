...
console.log(uni);
console.log(`There are ${uni.length} universities with the string "Uni" on the array`);
...
const populationValues = zooAnimals.map(element => element.population); //? 
populationTotal = populationValues.reduce( (accumulator,currentVal) => accumulator+currentVal);
